...
git remote add origin https://github.com/ayarfly-create/claude/apqp-ppap-system.git
...
```
https://github.com/ayarfly-create/claude/apqp-ppap-system
```
...
您的網站將發布於：
```
https://ayarfly-create.github.io/apqp-ppap-system/
```
